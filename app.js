...
const TRAD_TO_SIMP = {
  ...
  "鶥":"鹛","鸐":"𬸘","鸗":"𬸶","龐":"庞","節":"节","測":"测","發":"发",
  "將":"将","層":"层","機":"机","權":"权","結":"结","術":"术",
  "輕":"轻","轉":"转","達":"达","選":"选","邊":"边","鐵":"铁",
  "離":"离","難":"难","靈":"灵","麥":"麦","龍":"龙","龜":"龟"
};
function toSimplified(text) {
  return String(text || "").replace(/[並亞佈來係個們僅內兩凍別則劍動勢匯區協參員問單嚴囂國圍夠學實寬寶將對導層屬島嶼帶庫廣強後從愛態慶應換擁擊據擬擴數斷於時會東條棲業極構樣樹機橫權歐歡歸氣淺測溫滅滿漁潛澤濕濱灣為烏無熱爲爾牠狀猶獨獵現環產畫異當發禿種稱積穩節範築簑簡紀約紅紋納細結絕統經綠緋線縣縮續羅翹聞聯脅脇腳臉臺與興舊茲華葉著葦蒼藍蘇蘭處號蝦蟲蠣術衝裏裡見覓視親觀記訪許評詞話該認語誤說論諾識護變豐豔貓負責貿資賊賓贏趨蹺較輕轉農這連進過達遠適遷選遺還邊針錄鎮鐵鑽長開間闊關陸際隨隻雙雛雜雞離難雲電靈韓頁頂項領頭頸題額顏顛類顯風飛養餵馬馮體魚鮮鳥鳩鳳鳴鳶鴉鴒鴓鴛鴝鴞鴟鴦鴨鴴鴻鴿鵐鵑鵜鵝鵟鵠鵪鵯鵰鵲鶇鶉鶖鶘鶚鶥鶯鶲鶴鶺鶻鷂鷗鷦鷯鷲鷸鷹鷺鷿鸊鸐鸕鸗麥黃點龍龐龜]/g, c => TRAD_TO_SIMP[c] || c);
}
...
const DIST_KW_RE = /(?:分布[于在]|模式产地|分布於|分布在|常见[於于].{1,40}(?:地区|區域|大陆|國家)|广布[於于]|繁殖[於于在]|越冬[於于在]|南迁地区|南遷地區|冬候鸟|冬候鳥|从.{1,60}(?:经|到).{2,60}(?:到|一直).{2,60}|留鸟.{0,40}从.{2,60}到.{2,60}|造访.{0,30}(?:日本|韩国|朝鲜|台湾))[^。\n]*[。\n]/g;
